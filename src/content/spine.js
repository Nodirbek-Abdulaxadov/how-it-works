// Umumiy umurtqa: mashina kodidan fotongacha. Bu qatlamlar tilga bog'liq emas —
// 05-qatlamdan pastda "til" degan tushuncha allaqachon yo'qolgan.
// Faqat bir nechta satr tilga qarab almashadi (til boshidagi `lang` obyekti).
...
export const SPINE = [
  ...
  },
  {
    ...
    view: { z: 37, y: -1.6, w: 15 }
  },
  {
    id: "cpu",
    kicker: "MIKROARXITEKTURA",
  ...
  },
  {
    ...
    view: { z: 35, y: -3.2, w: 14.5 }
  },
  {
    id: "quantum",
    kicker: "KVANT FIZIKASI",
