...
kremniydagi elektronlar harakatiga aylanishini 11 qatlamda ko'rsatadi. Har bir
...
| 06 | Jarayon, virtual xotira, MMU va scheduler | operatsion tizim |
| 07 | CPU konveyeri, out-of-order, kesh ierarxiyasi | ~10⁻³ m |
| 08 | Mantiqiy elementlar, summator, flip-flop, soat | ~10⁻⁵ m |
| 09 | CMOS tranzistor: MOSFET va invertor | ~10⁻⁸ m |
| 10 | Kremniy kristalli, doping, PN o'tish | ~10⁻¹⁰ m |
| 11 | Zona nazariyasi, |ψ|² va kvant tunnellashuvi | kvant darajasi |
...
src/
  ...
  levels/
    ...
    system.js         06–08: OS va virtual xotira → CPU → mantiq
    hardware.js       09–11: tranzistor → kremniy → kvant fizikasi
...
`mov rcx, rax` ning kodlanishi `48 89 C8`, kremniyning taqiqlangan zonasi
1.12 eV. Konveyer 5 bosqich sifatida ko'rsatilgan — bu klassik RISC modeli;
